        ...
        <div className="w-full md:w-1/2 bg-brand-secondary mx-0 my-4 md:mx-24 md:my-24 rounded-3xl flex flex-col justify-center">
          <div className="p-4 md:p-8">
            ...
            <p className="text-gray-700 mb-6 md:mb-8 text-sm md:text-base">
              Create an account to start planning a trip that matches your style and preferences.
            </p>
            <div className="relative h-48 md:h-96 w-full">
              <Image src="/images/register.png" alt="Beach vacation scene" fill className="object-contain" />
            </div>
          </div>
        </div>
        ...
        <div className="w-full md:w-1/3 p-4 md:p-8 flex items-center justify-center">
          <div className="w-full max-w-md">
            <div className="flex justify-between items-center mb-6 md:mb-8">
              <h2 className="text-xl md:text-2xl font-bold">Register</h2>
              <Link href="/login" className="text-brand-primary hover:text-brand-primaryHover hover:underline text-sm md:text-base">
                Sign in
              </Link>
            </div>
